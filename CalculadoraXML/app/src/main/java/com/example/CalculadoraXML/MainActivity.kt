...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvClear.setOnClickListener { binding.tvExpression.text = ""
        ...
        binding.tvEquals.setOnClickListener {
            ...
            if (result == longResult.toDouble()){ binding.tvResult.text = longResult.toString()
            }else{
    ...
    private fun appendOnExpresstion(string: String, canClear: Boolean){ if(binding.tvResult.text.isNotEmpty()){
        binding.tvExpression.text = ""
    }

        if(canClear){ binding.tvResult.text = ""
